...
<script type="text/babel">
  ...
  import Locale from 'matt-ui/src/mixins/locale';
  import ElInput from 'matt-ui/packages/input';
  import ElSelectMenu from './select-dropdown.vue';
  import ElOption from './option.vue';
  import ElTag from 'matt-ui/packages/tag';
  import ElScrollbar from 'matt-ui/packages/scrollbar';
  import debounce from 'throttle-debounce/debounce';
  import Clickoutside from 'matt-ui/src/utils/clickoutside';
  import { addClass, removeClass, hasClass } from 'matt-ui/src/utils/dom';
  import { addResizeListener, removeResizeListener } from 'matt-ui/src/utils/resize-event';
  import { t } from 'matt-ui/src/locale';
  import scrollIntoView from 'matt-ui/src/utils/scroll-into-view';
  import { getValueByPath } from 'matt-ui/src/utils/util';
